...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-primary">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html"><b>Faiq Hotel</b></a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.html?id=2">Profile</a>
                    </li>
            ...
            <div class="col">
                <div class="card p-3 mb-2 bg-light text-dark" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <a href="viewRoomAvailable.html"  -->
                            <a href="viewRoom.html"
                        class="btn btn-primary stretched-link">Book Room</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card p-3 mb-2 bg-light text-dark" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <form name="viewMyBooking" method="post"
                                    action="${pageContext.request.contextPath}/ClientController"> -->
                        <div class="d-grid gap-2 mx-auto pt-1">
                            <!-- <input class=" btn btn-primary " type="submit" style="width:55%" id="command" name="command"
                                value="My-Booking"> -->
                                <a href="viewMyBooking.html" class="btn btn-primary stretched-link">My Booking</a>
                        </div>
            ...
            <div class="col">
                <div class="card p-3 mb-2 bg-light text-dark" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="viewRoomType.html" class="btn btn-primary stretched-link">View Room Type</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col">
                                <div class="card p-1 mb-2 bg-light text-dark" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="submit" class="btn btn-outline-primary btn-lg" id="command"
                                            name="command" value="Add-Room-Form" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card p-1 mb-2 bg-light text-dark" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="submit" class="btn btn-outline-danger btn-lg" id="command"
                                            name="command" value="Delete-Room" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card p-1 mb-2 bg-light text-dark" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="submit" class="btn btn-outline-success btn-lg" id="command"
                                            name="command" value="Update-Room" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-start justify-content-center">
                                    <div class="card p-1 mb-2 bg-light text-dark" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">To view booking table, check in and check out customer.
                                            <p>
                                                <a href="ManageBookingController?command=View-Booking-Page"
                                                    class="btn btn-primary stretched-link">View Booking Table</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
