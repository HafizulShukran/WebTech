...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <!-- <c:when test="${CLIENT  != null}">
              ...
              <div class="offset-md-3">
                <li class="nav-item">
                  <a href="manageUserController?command=Logout" class="btn btn-secondary" role="button"
                    data-bs-toggle="button">Logout</a>
                </li>
              </div>
            </c:when> -->
  ...
  <div class="container pb-5">
    <div class="row align-items-start justify-content-center">
      <h1>Room Type Available in Faiq Hotel</h1>
    </div>
    <div class="row align-items-center pt-4">
      ...
      <div class="col">
        <div class="card p-3 mb-2 bg-light text-dark" style="width: 18rem;">
          <!-- <% roomImage=((Room) roomQuadAvailable.get(i)).getRoomImage(); imgDataBase64=new
            String(Base64.getEncoder().encode(roomImage)); %> -->
            <img src="data:image/gif;base64,<%= imgDataBase64 %>" class="card-img-top" alt="..." />
            <div class="card-body">
